...
<section class="content">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('barangview/satuan/' . $satuan['id_satuan']); ?>" method="post">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_satuan" name="nama_satuan" required placeholder="Nama Satuan" value="<?= $satuan['nama_satuan']; ?>">
                            </div>
