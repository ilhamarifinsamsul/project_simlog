...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Laporan Pengeluran Barang</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-3 mb-2">
                            <button onclick="printArea('laporan/cetak')" class="btn btn-secondary">Cetak</button>
                        </div>
...
<script>
    ...
    function printArea() {
        ...
        var printPageURL = "<?= base_url('laporan/cetak'); ?>?start=" + start + "&end=" + end;
