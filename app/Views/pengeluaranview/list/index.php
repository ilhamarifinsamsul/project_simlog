...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">List Pengeluaran</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-12">
                <?php if (session()->get('id_role') ==  1) : ?>
                    <a href="<?= base_url('pengeluaranview/list/new'); ?>" class="btn btn-primary btn-sm mb-2">New</a>
                <?php endif; ?>
                <div class="card">
                            ...
                            <tbody>
                                ...
                                foreach ($pengeluaran as $d) : ?>
                                    <tr>
                                        ...
                                        <td><?= $d['keterangan']; ?></td>
                                        <td>
                                            <img src="<?= base_url(); ?>assets/upload/<?= $d['gambar']; ?>" width="100px" alt="">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if ($d['id_status'] == 1) : ?>
                                                ...
                                                <?php if (session()->get('id_role') == 2 || session()->get('id_role') == 2) : ?>
                                                    <a class="btn btn-warning btn-sm mb-2" href="<?= base_url('pengeluaranview/list/' . $d['id_pengeluaran'] . '/edit'); ?>">Edit</a>
                                                <?php else : ?>
                                                <?php endif; ?>
                                            <?php else : ?>
